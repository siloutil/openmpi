...
dnl
dnl Generated by ec2-user at Fri Jun 29 16:08:35 2018
dnl on ip-172-31-5-69.
dnl ---------------------------------------------------------------------------
...
m4_define([mca_opal_common_m4_config_component_list], [cuda, ofi, sm, verbs, verbs_usnic])
...
m4_define([mca_opal_hwloc_m4_config_component_list], [external, hwloc1117])
...
m4_define([mca_opal_pmix_m4_config_component_list], [cray, ext1x, ext2x, flux, pmix2x, s1, s2])
...
m4_define([mca_orte_errmgr_no_config_component_list], [default_app, default_hnp, default_orted, default_tool, dvm])
...
m4_define([mca_orte_oob_m4_config_component_list], [alps, tcp, ud])
...
m4_define([mca_orte_rml_m4_config_component_list], [ofi])
...
m4_define([mca_orte_state_no_config_component_list], [app, dvm, hnp, novm, orted, tool])
...
m4_define([mca_ompi_coll_no_config_component_list], [basic, inter, libnbc, self, sm, spacc, sync, tuned])
...
m4_define([mca_ompi_fcoll_no_config_component_list], [dynamic, dynamic_gen2, individual, static, two_phase])
...
m4_define([mca_ompi_io_m4_config_component_list], [ompio, romio314])
...
m4_include([opal/mca/hwloc/hwloc1117/configure.m4])
...
m4_include([opal/mca/pmix/pmix2x/configure.m4])
...
m4_include([orte/mca/rml/ofi/configure.m4])
